...
const HISTORY_I18N = {
  "ru": {
    "yurt_low_quality_texture": "Юрта — тысячелетнее переносное жилище кочевых казахов. Её отдалённые истоки — лёгкие шатры андроновской культуры бронзового века, а нынешняя форма полностью сложилась к XIII веку. Три главные части: кереге (решётчатые стены), уык (гнутые жерди-стропила) и шанырак (верхний купольный обод). К головкам кереге крепится более 60 уыков, ведущих к шаныраку, — и всё это без единого гвоздя. Дверь всегда обращена туда, откуда встаёт солнце: свет с востока — начало жизни. Внутреннее пространство строго разделено: төр (почётное место) — напротив входа, мужская половина — справа, женская — слева. Шанырак — символ очага и рода, его называют «языком» семьи. Юрту можно собрать всего за 40 минут. В 2014 году искусство изготовления и установки юрты внесено в список нематериального культурного наследия ЮНЕСКО. Изображение шанырака украшает и государственный герб Казахстана.",
    "dombyra_by_sultan_elamanov": "Домбыра — душа казахского народа, её история насчитывает более 4000 лет. Наскальные рисунки в пещере Майтобе в Алматинской области подтверждают существование подобных инструментов уже во II тысячелетии до н.э. Средневековые легенды о Коркыт-ата также содержат упоминания о домбыре. Главная особенность инструмента — искусство күй: способность двумя струнами передать чувства одного человека или целое историческое событие. В XIX веке сложились две школы: западная — с именами Курмангазы, Дины, Даулеткерея и кюями «Балбырауын», «Сарыарка», «Аксак кулан»; восточная — с именами Таттимбета, Абыла, Тюркеша и лирическим, распевным стилем. Корпус делают из вяза или берёзы, струны раньше свивали из верблюжьих жил, потом из нитей, сегодня — из нейлона. Длина инструмента около 1260 мм, 19 ладов. Сохранилось 62 домбровых кюя. 1 июля 2010 года учреждён Национальный день домбры. В 2014 году домбровое искусство внесено в список ЮНЕСКО.",
    "kazakh_qobyz_kobyz": "Кобыз — древнейший смычковый инструмент тюркского мира, его происхождение восходит примерно к IX веку. В казахском фольклоре создателем кобыза считается Коркыт-ата: согласно легенде, спасаясь от смерти, он пытался игрой на кобызе продлить жизнь. Инструмент вырезают из цельного куска дерева (берёзы, клёна), нижнюю часть обтягивают козьей кожей. Обе струны свиваются из конского волоса — от 60 до 100 тонких волосков. Смычок изогнутой формы, также натянут конским волосом. Звук кобыза точно передаёт человеческий голос, тень стонущего верблюда, плач ветра. Издревле это инструмент баксы — шаманов, которые таинственным звучанием призывали духов и исцеляли больных. В советское время исполнительство на кобызе почти угасло, но в XX веке его возродил Ыхлас Дукенулы. Сегодня в Национальной консерватории действует кафедра кобыза. Кюи Коркыта «Жер ұйығы» и «Ушардың ұласуы» исполняются и поныне.",
    "kazakh_shapan": "Шапан — длинный казахский халат, который носили и мужчины, и женщины; его корни уходят в средневековую тюрко-персидскую традицию. Ткань зависела от достатка владельца: шёлк, бархат, сукно, шерсть. Изнутри стёгали шерстью, пухом или хлопком, а самые дорогие халаты подбивали мехом чёрной кошки. Края отделывали тонкой тесьмой, петлями, золотой нитью. В орнаменте преобладают бараний рог, гусиная лапка, верблюжий след, древо жизни. Цвет указывал на социальный статус: белый шапан носили главы рода, голубой — младшие представители, чёрный — старшие по возрасту, а красно-коричневый предназначался для баев и биев. «Шапан жабу» — вручение халата — один из самых высоких знаков почёта у казахов. Сегодня шапан надевают на вновь избранных президентов, дарят деятелям искусства. Это неизменный наряд для тоя, больших собраний и приёма почётных гостей.",
    "taqiya_grey_m_kazakh_national_headdress": "Тақия — лёгкий круглый головной убор, предназначенный для тёплого времени года. Его корни — в древней тюрко-персидской традиции: похожие уборы можно увидеть на средневековых миниатюрах. Шьётся из бархата, шёлка, атласа, внутрь вставляется тонкий каркас, который держит форму. Мужская тақия обычно серого, чёрного, тёмно-синего или коричневого цвета. Снаружи её тщательно вышивают белой и золотой нитью — бараний рог, гусиная лапка, древо жизни. Тақия не является унисекс-убором: мужчины носят её отдельно (зимой поверх надевают шапку или малахай), а женщины — только под кимешеком или платком. В разных регионах свой стиль: на юге — высокая, конусовидная, на западе — плоская, на востоке — с богатой вышивкой. Сегодня тақия — современный национальный аксессуар, который молодёжь надевает на праздники и торжества.",
    "taqiya_yellow_f_kazakh_traditional_headdress": "Девичья тақия — символ девочки-подростка и незамужней девушки на выданье. В отличие от мужской, она отличается яркими цветами, золотой вышивкой и нарядными бусинами. Ткань — жёлтый, красный, голубой, зелёный бархат или шёлк. Сверху крепится одно или два пера филина: считалось, что перо оберегает от дурного глаза, а его потеря воспринималась как большая беда. Снизу свисают серебряные, золотые украшения, бусы, накосники. Тақию надевали на тои, на проводы невесты (ұзату той), на национальные праздники. После замужества на смену девичьей тақии приходит кимешек — символ женского статуса. Девичью тақию надевают и маленькой девочке на обряде тұсау кесер (перерезание пут). В современных казахских тоях дизайнеры возрождают тақию, создавая новые варианты — она популярна на фестивалях и свадебных церемониях.",
    "saukele_ethno_variant_traditional_headdress": "Сәукеле — самый дорогой и самый высокий головной убор казахской невесты, надеваемый на свадьбу. Его форма сложилась в XIV-XVIII веках. Высота достигает 70 см, а иногда и целого метра. Основа — плотная кожа или войлочный конус, обтянутый красным бархатом. Сверху — серебряные, золотые украшения, кораллы, сердолик, костяные вставки. На макушке — длинное лебединое перо, право носить которое имели только ханские дочери. По обеим сторонам свисают длинные шашбау — подвески из нитей кораллов, спускающиеся до груди и позвякивающие бусинами при каждом движении невесты. Сәукеле обычно изготавливался собственным мастером каждой знатной семьи и служил показателем её богатства. После свадьбы молодая невеста носит его 3-5 лет (иногда до рождения ребёнка), после чего его сменяет «жаулық» — простой головной платок. Сегодня сәукеле — один из самых дорогих экспонатов Национального музея, стоимость отдельных образцов оценивается в миллионы долларов.",
    "qamshy_kamshy": "Қамшы — неизменный спутник всадника и батыра, символ власти, глубокий знак казахской культуры. Рукоять делают из берёзы, рога горного козла, иногда из кости, длиной примерно 30-40 см. Плеть плетут из кожи телёнка или быка — из 8, 16 или 32 тонких ремешков; высшим мастерством считались плети из 64 полос. Общая длина — 1-1,5 метра. Рукоять украшают серебряными накладками и орнаментом. Существуют разные виды: конская камча (тонкая), боевая (жёсткая), праздничная (нарядная), детская (лёгкая). О властном человеке говорят «у него большая камча». На тоях вручение камчи вместе с подарком «сүйінші» считается большой честью. Камча служила и родовым знаком — у каждого жуза и рода был свой стиль плетения. В современном казахском спорте возрождаются скачки с камчой и игры с её использованием.",
    "Asyk": "Асық — древняя детская игра на бараньих бабках, уходящая корнями ещё в скифо-сакскую эпоху. Подобные игры в разных вариантах встречаются у тюркских, монгольских и персидских народов. У асыка четыре грани — сака (верхняя, ровная), алшы (наклонная), бук (изогнутая) — каждая грань в игре имеет своё значение. Казахские дети веками знали десятки вариантов игры: «Хан талапай», «Атбакыл», «Бес тас», «Уш табан», «Андыма-андыма». Сака-асык считается «царём» игры, и дети готовы на настоящие баталии, чтобы его завоевать. Игра в асык развивает у ребёнка логику, стратегическое мышление, точность и умение общаться. В древних обрядах асык использовали и для гадания. Сегодня в казахстанских школах вводят уроки игры в асык, а на национальных фестивалях проводят турниры. В 2017 году игра «асык» внесена в список нематериального культурного наследия ЮНЕСКО.",
    "besik": "Бесік — один из самых священных предметов казахской семьи. Его вырезают из берёзы, ивы или даже можжевельника — эти деревья считались «живыми». Колыбель украшают резьбой и серебряными накладками, длина — около 700 мм. Важнейшая деталь — «шумек» в нижней части, специальное устройство для отвода естественных выделений младенца, куда крепился бараний курдюк (қошақан). С колыбелью связано несколько важных обрядов: «Бесікке салу» — первое укладывание пятидневного младенца в колыбель, которое совершают бабушки; «Тұсау кесер» — перерезание символической верёвки на ножках ребёнка, когда он начинает ходить; «Шілдехана» — праздник в честь сорокадневного младенца. Сверху на бесік кладут кошачью шкуру или тумар (оберег) — для защиты от дурного глаза. Колыбельные «Әлди-әлди» казахские матери слагали и передавали веками, сегодня они внесены в список ЮНЕСКО.",
    "nomad_sabre": "Клинок — холодное оружие казахского воина, чья история восходит к древней сакской эпохе. В VII-VIII веках дулаты и кипчаки в казахской степи широко использовали сабли. Клинок ковали из высококачественной стали — часто дамасской или хорасанской. Рукоять делали из берёзы, рога или кости, иногда украшали слоновой костью. Длина клинка — 90 см, вес — 1-1,2 кг. Ножны (саксай) обтягивали кожей, концы украшали серебром и золотом. Саблю передавали в семье как реликвию из поколения в поколение. В годы джунгарского нашествия (1723-1750) батыры Абылай, Абылмансур, Райымбек, Богенбай, Кабанбай, Наурызбай сражались этими саблями против бедствий «Актабан шубырынды», освобождая землю. В XIX веке в войске хана Кенесары сабля оставалась главным оружием. Сегодня такие клинки хранятся в музеях и как семейные реликвии.",
    "balbal_tas": "Балбал тас — каменные изваяния в форме человека, созданные в эпоху древних тюрков (VI-IX века). Слово «балбал» восходит к тюркскому «баба» — «великий предок, покровитель». Такие изваяния ставили на могилах прославленных воинов, ханов и биев. Сотни подобных памятников найдены в Казахстане, Монголии, на Алтае, в Тянь-Шане и на юге Сибири. У некоторых статуй в руках — чаша, символизирующая вечный пир в мире мёртвых. У других закреплены сабля, камча, поясная пряжка. Вместе с покойным хоронили его оружие, коня, а иногда жену и скот — считалось, что на том свете он продолжит жить со своим имуществом. Древние тюрки почитали каменные изваяния как святыню, приносили им жертвы и устраивали поминальные трапезы в честь духа умершего. Современные казахские надгробия-кулпытасы — прямое эхо балбал тасов. Сохраняются в национальных музеях и на этно-мемориалах под открытым небом.",
    "tamgaly_sun_man": "Петроглифы Тамгалы — древний памятник наскального искусства в Алматинской области, в 170 км к северо-западу от Алматы. Здесь найдено более 5000 наскальных изображений, самые ранние из которых относятся к бронзовому веку (XIV-XI века до н.э.). Одно из самых знаменитых изображений — «солнцеголовый человек» (Solar-headed deity): голова изображена в виде диска с расходящимися лучами, руки широко раскинуты. Возможно, это образ Солнца-божества древней тюрко-иранской мифологии — Митры или Дингира. Здесь же, судя по всему, проходили древние шаманские обряды — поблизости найдены площадки для жертвоприношений и захоронения. В 2004 году Тамгалы включён в список Всемирного наследия ЮНЕСКО — один из трёх объектов такого статуса в Казахстане. Сегодня здесь работает археологический музей под открытым небом, проводятся экскурсии для туристов.",
    "astau_tabaq": "Астау (или тегене) — «шанырак» казахского дастархана, главное деревянное блюдо. Вырезается из цельного куска берёзы, ивы или ели. Диаметр — 50-80 см, глубина — 15-20 см. Край обычно украшен орнаментом «бараний рог», «древо жизни», «солнце-звезда». Изготовление требует терпения: мастер сушит дерево 3-6 месяцев, затем вырезает форму специальной стамеской — вручную, без станков. Самые большие астау называют «астау патша» («царь-астау»), они рассчитаны на 30-40 гостей праздника. На астау подают бесбармак (мясо с тестом), казы, плов, кебаб. Поднести старшему кишку бесбармака — большая честь, обряд «бас ұсыну». Существует традиция дарить отдельный астау молодой семье — «астау беру», свадебный подарок. Прежде у каждой семьи был свой астау, который передавался по наследству. У современных казахов бесбармак на астау по-прежнему занимает главное место на тое.",
    "torsyk_kymyz": "Торсык — коричневый кожаный сосуд для хранения кумыса, воды или шубата. Его происхождение восходит к скифо-сакской эпохе — при раскопках находили обломки подобных кожаных изделий. Процесс изготовления сложен: шкуру с грудной части взрослого телёнка или быка тщательно очищают, дубят, обрабатывают кислым молоком, а затем сшивают тонким швом по краям с двух сторон. Снаружи специальными штампами наносится орнамент «рог», растительные и цепочечные узоры. Горлышко узкое, с деревянной пробкой. Особенность торсыка в том, что кумыс внутри продолжает естественно бродить и остаётся прохладным даже в жару. В Западном Казахстане, особенно в Атырауской и Западно-Казахстанской областях, мастера таких кожаных сосудов работают и по сей день. Этот экспонат — из Западно-Казахстанского областного историко-краеведческого музея, подлинный образец XIX века.",
    "sedlo": "Седло (ер-тоқым, или просто «ер») — неотъемлемый спутник воина и охотника, вершина тысячелетней кочевой культуры. Его использовали ещё в сакскую эпоху. Деревянный каркас (қас) вырезают из твёрдой берёзы, внутри обтягивают кожей, шерстью, иногда войлоком. Снаружи седло покрывают кожей и наносят орнамент. Изначально седло предназначалось только для воинов-мужчин, но в XVIII-XIX веках появились изящные женские сёдла — тонкие, нарядные. Данное седло XIX века из Западно-Казахстанского областного музея украшено ажурными позолоченными пластинами, в центре — вставки из красного сердолика. Такие сёдла принадлежали только ханам, биям или богатым семьям. В конструкции седла — более 30 деталей: подпруга, нагрудник, узда, поводья, стремена, нашейный ремень. Современные казахи до сих пор используют подобные сёдла на торжественных церемониях.",
    "aibalta": "Айбалта — боевое оружие казахского воина, известное ещё со времён древних тюрков. Название происходит от формы: «ай» (полумесяц) + «балта» (топор). Лезвие изогнуто в форме полумесяца, его длина 15-25 см. Рукоять из дерева или рога, длиной 60-80 см, вес оружия — 1-2 кг. Изначально применялось преимущественно в военных целях — в ближнем бою, чтобы одним ударом на скаку свалить противника. Рукоять обычно оковывали серебром, украшали серебряными накладками и кольцами. У некоторых айбалт в рукояти проделано отверстие для тонкого шнура — чтобы оружие не выпало из рук в бою. В XVIII-XIX веках айбалта была не только оружием, но и отличительным знаком биев и баев, а в сказаниях выступает и как волшебное оружие. В западноказахстанском фольклоре встречаются образы «айбалталы Абылай», «айбалталы Наурызбай». Этот экспонат XIX века — из Западно-Казахстанского областного историко-краеведческого музея.",
    "qalqan": "Қалқан — защитное оружие воина, тысячелетнее наследие степи. Данный щит XVIII века — один из ценных экспонатов Национального музея. Он изготовлен из выпуклого (сфероидного) стального листа диаметром около 50-60 см. Край и центральная часть окантованы пластинами из латуни. На поверхности искусно выгравированы изображения пеших и конных воинов, диких животных (архара, барса), а также надписи в стиле куфи (арабская каллиграфия). Куфические надписи содержат коранические аяты, обращённые к воину («Власть принадлежит Аллаху...»), и защитные молитвы. Внутренняя сторона обтянута красной тканью и мягкой кожей — чтобы смягчать удары. Такие изысканные щиты принадлежали лишь ханзадам и биям и редко использовались в реальном бою — чаще их демонстрировали на парадах и торжествах. Вершина мастерства тюркских, казахских и среднеазиатских оружейников.",
    "kubi": "Күбі — деревянный сосуд для приготовления кумыса. Форма трапециевидная (узкая сверху, широкая снизу), высота — 60-80 см. Изготавливается из тонких сосновых досок-клёпок, стянутых тремя-четырьмя тёмными металлическими обручами. Внутри используется піспек — деревянный инструмент с длинной ручкой (около 90 см), на нижнем конце которого закреплён специальный резной диск-мешалка. Процесс приготовления таков: кобылье молоко заливают в күбі, добавляют закваску, затем сбивают піспеком 1000-2000 раз в день. Благодаря этому механическому процессу молоко сквашивается, получается «тың қымыз» — свежий кумыс. Иногда делали күбі в полтора-два раза крупнее — для больших тоев. В семьях Акмолинской, Карагандинской и Павлодарской областей такие күбі использовались в быту вплоть до середины XX века. Современные казахи до сих пор применяют күбі в кумысном хозяйстве.",
    "ojau": "Ожау — деревянный черпак для разливания кумыса, айрана, шубата из астау по чашам. Вырезается из цельного куска дерева (берёзы, ивы, чёрного дерева). Длина — 30-50 см, глубина чаши — 6-10 см. Ручка длинная, удобная для хвата, иногда украшена тонкой резьбой. Основная часть посуды древних кочевников была именно деревянной — она не скользила, не билась, была лёгкой и удобной в перевозке. Ожау играет важную роль в застольном обряде: он всегда в руках старшего, который разливает кумыс по старшинству гостей. На больших тоях одновременно работают десятки ожау. Некоторые мастера украшают ожау резьбой и снабжают его специальным крючком снизу — чтобы вешать на стену. Экспонат из музея Акмолинской области (в окрестностях Астаны), начало XX века. Современные казахи используют ожау на этно-фестивалях и в национальной кухне.",
    "sandyq": "Сандық — деревянный сундук, в котором казахская семья хранила самые ценные вещи. Он играл важную роль и в кочевых перекочёвках — его грузили на верблюда в дальнюю дорогу. Материал — берёза, ива, чёрная берёза, иногда кедр. Длина — 80-120 см, высота — 40-60 см. Снаружи сундук обивали тонким железом — это служило не только защитой, но и украшением. В центре и по бокам крепились серебряные и латунные пластины с резьбой и гравировкой. Внутри хранились: жасау (приданое, которое девушка увозит в новую семью), вышитый шапан, кимешек, серебряные украшения, книги, семейные реликвии. Пожелание «сандық толы» произносили во время вручения приданого — в смысле «пусть твоя семья будет полной чашей». В старину сундук изготавливали особые мастера, а механизм его открывания-закрывания считался настоящим искусством. У некоторых сундуков замок открывался тремя-четырьмя разными ключами — сложное устройство. У современных казахов сандық — символ древней культуры.",
    "togyzqumalaq": "Тоғызқұмалақ — древняя степная логическая игра, известная у казахов, киргизов и туркмен. «Тоғыз» + «құмалақ» переводится как «девять камешков». Она восходит к семейству игр манкала, зародившихся 4-5 тысяч лет назад в Африке и распространившихся по Великому Шёлковому пути. Доска для тоғызқұмалақа вырезается из дерева, иногда из камня. По обеим сторонам — по девять лунок, в центре — два больших «казана» для собранных камешков. В начале игры в каждой лунке по 9 камешков, всего 162. Игроки по очереди забирают камешки из лунки и распределяют их по часовой стрелке. Есть сложные правила: «отау» (правильное устройство лунки-ловушки), «түсім» (сбрасывание камешка сопернику). Обычно партия длится 30-60 минут, а между гроссмейстерами может продолжаться 3-4 часа. В 1949 году была создана республиканская федерация Казахстана. Сегодня проводятся чемпионаты мира, игра — официальный вид спорта на Азиатских играх. В школах вводят уроки тоғызқұмалақа.",
    "sazsyrnai": "Саз сырнай — древний духовой инструмент из обожжённой глины, изготавливавшийся на туркестанской земле. Его происхождение восходит к бронзовому веку — II-I тысячелетиям до н.э. Форма напоминает крупное яйцо, с 6-12 отверстиями для звука. В старину это был в основном инструмент пастухов и детей — на нём играли летом на джайляу, пока паслись стада. Иногда его использовали и в религиозных обрядах — считалось, что глиняный инструмент напрямую связан с природой. Диапазон звучания ограничен, но тембр чистый и своеобразный. Современные саз сырнаи возрождают гончарные мастера, придавая им разные формы — овцы, верблюда, птицы, шанырака юрты. Экземпляр, созданный в честь 1500-летия Туркестана (2000 год), хранится в Национальном музее — на нём изображены мавзолей Ходжи Ахмеда Ясави, караван верблюдов и надпись «Түркістан 1500». Сегодня этно-музыканты используют саз сырнай в этно-джазе и стиле world music.",
    "shanqobyz": "Шаңқобыз (варган) — древний язычковый инструмент, известный тюркским, монгольским, финно-угорским народам и даже американским индейцам. Его происхождение относят к периоду 4-5 тысяч лет назад в Азии. Изготавливается из металлической (иногда деревянной) пластины с тонким гибким язычком посередине. Техника игры такова: инструмент плотно зажимают между передними зубами, а язычок приводят в движение пальцем. Ротовая полость служит резонатором — изменяя положение языка, губ и дыхание, музыкант извлекает разные мелодии. Использовался в древних шаманских обрядах, трансовой медитации, ночных играх. В казахских походах считалось, что игра на шаңқобызе ночью «призывает духов души». Юноша мог сыграть на шаңқобызе собственную мелодию, чтобы признаться девушке в чувствах. В начале XX века инструмент был почти забыт, сегодня его возрождают национальные музыканты. Экспонат из музея Акмолинской области — современный инструмент, изготовленный в 2015 году, но по традиционной технологии. Во всём мире варган популярен в этно-джазе и world music.",
    "perstenj": "Перстень «птичий клюв» — работа костанайских ювелиров XIX века, яркий образец казахского национального ювелирного искусства. Каст (гнездо для камня) овальной формы, с заострёнными концами, напоминающими птичий клюв, — отсюда и название. Материал — высококачественное серебро, внутри закреплён небольшой камень (агат, сердолик или бирюза). Техники украшения: скань (плетение из тонкой серебряной проволоки), зернь (напайка мелких серебряных шариков), плетёный косичковый ободок. По древнему казахскому поверью, перстни были не просто украшением, а выполняли роль тумара (оберега): камень внутри защищал владельца от дурного глаза и болезней. У каждого камня своё значение: агат — авторитет, сердолик — семейное благополучие, бирюза — удачный путь. В Костанайской, Актюбинской, Западно-Казахстанской областях у каждой ювелирной семьи было своё мастерство, секреты которого передавались только по наследству. Данное изделие хранится в Костанайском областном историко-краеведческом музее.",
    "bilezik": "Білезік (браслет) — один из главных украшений казахских женщин с древнейших времён. Браслеты, найденные в древних курганах, датируются VII-V веками до н.э. (сакская эпоха). Материалы разнообразны: серебро, золото, сочетание серебра с золотом; разноцветные камни — сердолик, коралл, бирюза, агат. Представленное изделие — работа современного казахского ювелира Шапабаева Кайрата Булатовича. Браслет массивный, разомкнутой формы (не замкнут в кольцо, что позволяет легко надевать его на руку), поверхность украшена геометрическим орнаментом — треугольники, ромбы, круги. Центральный акцент — три овальных агатовых камня, равномерно расположенных по окружности браслета. Камни закреплены в выступающих оправах. По древней тюркской традиции браслет тоже служил оберегом — считалось, что вид браслета на правой руке приносит счастье. Это свадебный подарок, нарядное украшение, которое дарили девушкам на праздники. Экспонат Музея декоративно-прикладного искусства имени Шаймердена Сариева — одной из крупнейших ювелирных коллекций Казахстана.",
    "kese": "Кесе — керамический сосуд XVIII-XIX веков, происходящий из городов на Великом Шёлковом пути — Отрара, Тараза, Сайрама. Средневековый Отрар (Фараб) был одним из крупнейших центров гончарного дела в Центральной Азии — именно здесь родился Аль-Фараби, а сам древний город процветал в V-XVI веках. Процесс изготовления керамики таков: местную глину собирают, формуют на гончарном круге, затем обжигают в специальной печи при температуре 800-1000°C. Особая техника этого кесе — «подглазурная роспись по белому фону»: на белую глазурь наносится узор голубыми и коричневыми минеральными красками. Орнамент включает растительные мотивы (древо жизни), геометрические фигуры, иногда надписи в стиле куфи. Кесе традиционно использовали для питья кумыса, чая, талкана. Данное изделие — экспонат историко-культурного комплекса «Шым қала», этнографического музея под открытым небом близ Шымкента. Оно словно возрождает дух средневековых Отрара, Сайрама и Испиджаба.",
    "korzhyn": "Қоржын — традиционная дорожная перемётная сума кочевых казахов, которую вешали парой на коня или верблюда. Известна ещё со времён сакской эпохи — в пазырыкских курганах найдены обломки подобных ковровых сум. Материал — плотная шерстяная нить, спряденная из овечьей или верблюжьей шерсти, иногда окрашенная растительными красителями. Техники изготовления — терме и қажақи ткачество, древние и сложные способы, позволяющие создавать красочные узоры. Форма прямоугольная, в месте сгиба образуется «горловина» — узкий ремень, который перекидывают через седло или плечо. По обеим сторонам одинаковый орнамент — символ равновесия. Самые распространённые узоры: ромбовидный медальон (символ солнца, мира, семьи), бараний рог (символ изобилия), звезда, цветок, цепочка. Цветовая палитра: насыщенный красный (в центре, доминирующий цвет), белый, чёрный, зелёный, лиловый, жёлтый — всё из природных красителей (марена, куркума, инжирный лист). По краям — кисточки из нитей, означающие защиту от дурного глаза (роль оберега). Внутрь клали дорожную еду, посуду, мелкие вещи, иногда книги. Важная часть приданого невесты на свадьбе — қоржын передавался из поколения в поколение в новую семью как реликвия предков. У современных казахов қоржын используется как элемент дизайна: сумки, декор интерьера, аксессуар национальных праздников. Данный экспонат — из собрания Национального музея Республики Казахстан.",
    "syrmaq": "Сырмақ — самый сложный и изысканный вид традиционного казахского войлочного ковра. Его основа — войлок (плотное валяное полотно из овечьей или верблюжьей шерсти), а техника исполнения — «мозаичная аппликация». Процесс изготовления таков: сначала сваливают войлок двух цветов (обычно тёмно-коричневый и белый). Затем мастер вырезает из каждого полотна одинаковые фрагменты с заранее нанесённым узором. Кусочки соединяют мелким тонким швом — так рождаются ромбовидные медальоны, растительные мотивы, орнамент «бараний рог». На один сырмак может уйти от 3 до 6 месяцев. Три ромбовидных медальона в центре трактуются как символ трёх жузов или членов семьи. Сложный ветвящийся узор внутри медальона — «древо жизни», отголосок древней тюрко-иранской мифологии. Окружающий его орнамент «бараний рог» символизирует изобилие, отсылая к скотоводству как главному богатству. Цветовая палитра этого сырмака: насыщенный коричневый (доминирующий), белый (внутри медальона), местами лиловые и красные акценты. Сырмак расстилали на почётном месте юрты — төр, иногда он входил в приданое невесты. В старину у каждого казахского аула был свой сырмак — со своими поверьями и своей историей. Сегодняшние мастера (особенно в Туркестанской области) сохраняют эту традицию, создавая сырмаки, подходящие для современного интерьера. Ведётся подготовка к включению сырмака в список нематериального культурного наследия ЮНЕСКО.",
    "dulyga": "Дулыға — железный защитный шлем казахского воина. Его дальние истоки — железные шлемы сакской, гуннской, тюркской эпох, VII-V века до н.э. Подобные железные и бронзовые шлемы найдены в пазырыкских курганах. В XVIII-XIX веках, во время казахских походов, дулыға оставалась главным средством защиты головы — в годы джунгарского нашествия (1723-1750) батыры Абылай, Кабанбай, Наурызбай, Богенбай выходили на бой именно в таких шлемах. Представленный экспонат — точная реконструкция, выполненная современным мастером Алибаем Бериком Сатынбекулы на основе подлинных образцов XVIII-XIX веков. Конструкция сложная: верхняя часть — куполообразная, выкована из цельного железного листа, на макушке — острый металлический штырь (для устрашения врага либо для крепления перьев или бунчука). В лобной части — тонкая налобная пластина, защищающая глаза воина. Снаружи нанесена резьба в стиле арабской каллиграфии — коранические аяты и защитные молитвы (сура «Ан-Наср»). В нижней части — бармица (кольчужная сетка), сплетённая из тонких (диаметром 5-8 мм) железных колец, прикрывающая затылок. Бармица защищала затылок, шею и плечи от удара сабли. В одной бармице может быть 15-20 тысяч колец — её изготовление занимает у мастера несколько месяцев. В старину бармица была принадлежностью только ханов и знатных батыров — чрезвычайно дорогая вещь. Алибай Берик Сатынбекулы — современный кузнец, возрождающий древнюю традицию обработки железа. В его мастерской полностью воссоздаётся снаряжение казахского воина XVIII-XIX веков. Экспонат хранится в Музее декоративно-прикладного искусства имени Шаймердена Сариева."
  },
  "en": {
    "yurt_low_quality_texture": "The yurt is the millennia-old dwelling of the nomadic Kazakhs. Its distant origins lie in the light Bronze Age shelters of the Andronovo culture, while its present form was fully established by the 13th century. Three main parts make up its frame: the kerege (lattice walls), the uyk (bent roof poles), and the shanyrak (the crown-shaped upper ring). More than 60 uyk poles run from the kerege to the shanyrak — all without a single nail. The door always faces the direction of the sunrise: light entering from the east marks the beginning of life. The interior is carefully divided: the tor (place of honor) sits opposite the entrance, the men's side is on the right, the women's side on the left. The shanyrak is the symbol of the hearth and the family line, often called the household's 'tongue.' A yurt can be assembled in as little as 40 minutes. In 2014, the art of yurt-making was inscribed on UNESCO's Representative List of the Intangible Cultural Heritage of Humanity. An image of the shanyrak also appears on the State Emblem of Kazakhstan.",
    "dombyra_by_sultan_elamanov": "The dombyra is the soul of the Kazakh people, with a history spanning more than 4,000 years. Rock carvings in the Maytobe cave in Almaty Region confirm that instruments like it already existed in the 2nd millennium BCE, and medieval legends about the sage Korkyt Ata also mention it. What sets the dombyra apart is the art of the kuy — the ability to convey a single person's feelings, or an entire historical event, through just two strings. In the 19th century two schools emerged: the Western school, associated with Kurmangazy, Dina, and Dauletkerei, and kuis such as 'Balbyrauyn,' 'Saryarka,' and 'Aksak Kulan'; and the Eastern school, associated with Tattimbet, Abyl, and Turkesh, known for its lyrical, flowing style. The body is carved from elm or birch; the strings were once twisted from camel sinew, later from thread, and today from nylon. The instrument measures about 1,260 mm in length and has 19 frets. Sixty-two dombyra kuis have survived to this day. On 1 July 2010, Kazakhstan declared a National Dombyra Day, and in 2014 the art of dombyra music was added to UNESCO's Intangible Cultural Heritage list.",
    "kazakh_qobyz_kobyz": "The kobyz is the oldest bowed string instrument in the Turkic world, tracing back to roughly the 9th century. In Kazakh folklore its invention is credited to Korkyt Ata: legend says that, fleeing death, he tried to prolong life through the sound of the kobyz. The instrument is carved from a single piece of wood (birch or maple), with the lower body covered in goatskin. Both strings are twisted from horsehair — anywhere from 60 to 100 fine strands — and the curved bow is likewise strung with horsehair. Its voice can convincingly evoke a human cry, the shadow of a moaning camel, or the mourning of the wind. It was long the instrument of baksy — shamans — who used its mysterious sound to summon spirits and heal the sick. Performance on the kobyz nearly died out in the Soviet era, until it was revived in the 20th century by Ykhlas Dukenuly. Today the National Conservatory has its own kobyz department, and Korkyt's kuis 'Zher Uiygy' and 'Ushardyng Ulasuy' are still performed.",
    "kazakh_shapan": "The shapan is a long Kazakh robe worn by both men and women, rooted in the medieval Turkic-Persian tradition. Its fabric reflected the owner's wealth — silk, velvet, broadcloth, or wool. It was quilted inside with wool, down, or cotton, and the finest robes were lined with black cat fur. The edges were trimmed with fine cord, hooks, or gold thread, and the ornamentation typically features ram's horns, goose feet, camel tracks, and the tree of life. Color marked social standing: a white shapan was worn by the head of a clan, blue by junior representatives, black by elders, and red-brown was reserved for the wealthy and for biys (judges). 'Shapan zhabu' — draping someone in a shapan — is one of the highest honors in Kazakh culture. Today it is placed on the shoulders of newly inaugurated presidents and given as a gift to prominent artists. It remains the fitting garment for weddings, gatherings, and welcoming honored guests.",
    "taqiya_grey_m_kazakh_national_headdress": "The taqiya is a light, round headdress meant for the warm season. Its roots lie in ancient Turkic-Persian tradition — similar headwear appears in medieval miniatures. It is sewn from velvet, silk, or satin, with a thin stiffener inside to hold its shape. Men's taqiyas are usually grey, black, dark blue, or brown, carefully embroidered on the outside in white and gold thread with motifs such as ram's horns, goose feet, and the tree of life. The taqiya is not unisex: men wear it on its own (adding a hat or fur cap in winter), while women wear it only underneath a kimeshek or headscarf. Styles vary by region — tall and conical in the south, flat in the west, richly embroidered in the east. Today the taqiya is a modern national accessory, worn by young people at holidays and celebrations.",
    "taqiya_yellow_f_kazakh_traditional_headdress": "The girl's taqiya is a symbol of adolescence and unmarried maidenhood. Unlike the men's version, it stands out for its bright colors, gold embroidery, and decorative beadwork. It is made of yellow, red, blue, or green velvet or silk. One or two owl feathers are fastened to the top — the feather was believed to ward off the evil eye, and losing it was considered a serious misfortune. Silver and gold ornaments, beads, and hair pendants hang from beneath it. It was worn at celebrations, at the bride's send-off feast (uzatu toi), and on national holidays. After marriage, the girl's taqiya gives way to the kimeshek, the symbol of womanhood. It is also worn by young girls at the tusau keser ceremony, when a child's first steps are marked by cutting a symbolic tether. In today's Kazakh weddings, designers are reviving the taqiya with new styles, and it remains popular at festivals and wedding ceremonies.",
    "saukele_ethno_variant_traditional_headdress": "The saukele is the most expensive and the tallest headdress worn by a Kazakh bride at her wedding. Its form took shape between the 14th and 18th centuries. It can stand up to 70 cm tall — sometimes even reaching a full meter. The base is a cone of thick leather or felt covered in red velvet, decorated with silver, gold, coral, carnelian, and bone ornaments. A tall swan feather crowns the top — a privilege once reserved for khans' daughters alone. Long shashbau — tassels of coral strands — hang down both sides to the chest, chiming softly with every movement of the bride. A saukele was typically made by a craftsman attached to each noble family and served as a display of that family's wealth. After the wedding, the young bride wears it for three to five years (sometimes until the birth of her first child), after which it is replaced by the zhaulyk, a plain headscarf. Today the saukele is among the most valuable exhibits in Kazakhstan's National Museum, with individual pieces valued in the millions of dollars.",
    "qamshy_kamshy": "The qamshy (whip) was the constant companion of the horseman and the batyr, a symbol of authority and a deeply rooted marker of Kazakh culture. Its handle is made of birch, mountain-goat horn, or sometimes bone, roughly 30-40 cm long. The lash is braided from calf or ox hide, from 8, 16, or 32 thin strips of leather — the finest craftsmanship produced whips braided from 64 strands. The whole whip runs 1 to 1.5 meters, and its handle is decorated with silver fittings and ornament. Several types existed: the horse whip (thin), the warrior's whip (stiff), the festive whip (richly decorated), and the child's whip (light). A person of authority was described as having 'a big qamshy.' At celebrations, presenting a qamshy along with the customary 'suyinshi' gift was considered a great honor. It also served as a tribal marker, with each zhuz and clan favoring its own braiding style. Today, qamshy races and games are being revived in modern Kazakh sport.",
    "Asyk": "Asyk is an ancient children's game played with sheep anklebones, with roots reaching back to the Scythian-Saka era. Similar games, in various forms, exist among Turkic, Mongol, and Persian peoples. The asyk bone has four sides — saka (flat, uppermost), alshy (leaning), and buk (curved) — each carrying its own meaning in play. For centuries, Kazakh children knew dozens of variants of the game, including 'Khan Talapai,' 'Atbakyl,' 'Bes Tas,' 'Ush Taban,' and 'Andyma-Andy.' The saka asyk is the 'king' of the game, and children compete fiercely to win it. Playing asyk teaches a child logic, strategy, precision, and social skill. In ancient rituals, asyk bones were also used for divination. Today, asyk lessons are being introduced in Kazakh schools, and tournaments are held at national festivals. In 2017, the game of asyk was inscribed on UNESCO's Intangible Cultural Heritage list.",
    "besik": "The besik (cradle) is one of the most sacred objects in a Kazakh household. It is carved from birch, willow, or even juniper — trees considered 'living.' The cradle is decorated with carving and silver fittings and measures about 700 mm long. Its most important feature is the 'shumek' in the lower section — a special device for channeling away the infant's waste, fitted with a piece of sheep's tail (koshaqan). Several important rituals surround the cradle: 'besikke salu,' the first placing of a five-day-old infant into the cradle, performed by the grandmothers; 'tusau keser,' the cutting of a symbolic cord tied around the child's legs once they begin to walk; and 'shildehana,' a celebration held for a baby's fortieth day. A cat's pelt or an amulet is laid over the cradle to ward off the evil eye. The Kazakh lullabies known as 'aldi-aldi' developed over centuries and are now included on UNESCO's heritage list.",
    "nomad_sabre": "The sabre was the Kazakh warrior's bladed weapon, with roots reaching back to the ancient Saka era. In the 7th-8th centuries, the Dulat and Kypchak tribes made wide use of sabres across the Kazakh steppe. Blades were forged from high-grade steel, often Damascus or Khorasan steel; hilts were made of birch, horn, or bone, sometimes inlaid with ivory. A typical blade measured 90 cm and weighed 1-1.2 kg. The scabbard (saqsai) was covered in leather, its ends finished in silver and gold. Sabres were handed down within families as heirlooms, generation after generation. During the Dzungar invasion (1723-1750), the batyrs Abylai, Abylmansur, Raiymbek, Bogenbai, Kabanbai, and Naurizbai fought with such sabres against the catastrophe known as 'Aktaban Shubyryndy,' freeing their land. In the 19th century, the sabre remained the primary weapon of Khan Kenesary's army. Today these blades survive in museums and as family heirlooms.",
    "balbal_tas": "Balbal tas are human-shaped stone monuments carved during the ancient Turkic era (6th-9th centuries). The word 'balbal' derives from the Turkic 'baba' — 'great ancestor, protector.' They were erected at the graves of renowned warriors, khans, and biys. Hundreds of such monuments have been found across Kazakhstan, Mongolia, the Altai, the Tian Shan, and southern Siberia. Some figures hold a bowl in their hands, symbolizing an eternal feast in the afterlife; others bear a sabre, a whip, or a belt buckle. The deceased was buried together with his weapon, his horse, and sometimes his wife and livestock — it was believed he would continue on in the afterlife with his possessions. The ancient Turks regarded these stone figures as sacred, offering sacrifices and memorial feasts to the spirit of the departed. Today's Kazakh gravestones (kulpytas) are a modern echo of the balbal tas tradition. Examples are preserved in national museums and open-air ethnographic memorials.",
    "tamgaly_sun_man": "The Tamgaly petroglyphs are an ancient rock-art site in Almaty Region, some 170 km northwest of the city of Almaty. More than 5,000 carved images have been documented here, the earliest dating to the Bronze Age (14th-11th centuries BCE). One of the most famous images is the 'sun-headed man' — its head rendered as a disc surrounded by radiating rays, arms spread wide. It may depict a solar deity from ancient Turkic-Iranian mythology, such as Mithra or Dingir. The site also appears to have hosted ancient shamanic rites, with sacrificial platforms and burial grounds found nearby. In 2004, Tamgaly was inscribed on the UNESCO World Heritage List — one of only three sites in Kazakhstan to hold that status. Today it operates as an open-air archaeological museum, with guided tours offered to visitors.",
    "astau_tabaq": "The astau (also called tegene) is the 'shanyrak' of the Kazakh dastarkhan — the central wooden serving dish. It is carved from a single piece of birch, willow, or fir, 50-80 cm across and 15-20 cm deep. Its rim is typically decorated with the ram's-horn, tree-of-life, or sun-and-star motifs. Making one takes patience: the craftsman dries the wood for three to six months, then carves the shape by hand with a special chisel, with no machinery involved. The largest astaus, known as 'astau patsha' ('king astau'), are made to serve 30-40 guests at a large celebration. Foods such as besbarmak (meat with dough), kazy, pilaf, and kebab are served on it. Offering an elder the intestine from a besbarmak dish is a great honor, part of the 'bas usynu' ritual. There is also a tradition of gifting a young family its own astau, known as 'astau beru,' a wedding present. In the past, each family had its own astau, handed down as an heirloom. Among Kazakhs today, besbarmak served on the astau still holds the place of honor at any celebration.",
    "torsyk_kymyz": "The torsyk is a brown leather vessel used to store koumiss, water, or shubat. Its origins trace back to the Scythian-Saka era — excavations have unearthed fragments of similar leather containers. Making one is a demanding process: hide from the breast area of an adult calf or ox is carefully cleaned, tanned, and treated with sour milk, then the two halves are joined along the edges with a fine seam. The outside is stamped with 'horn,' plant, and chain-link patterns using special tools. The neck is narrow and fitted with a wooden stopper. What sets the torsyk apart is that the koumiss inside continues to ferment naturally and stays cool even in hot weather. Craftsmen who make these leather vessels still work today in western Kazakhstan, particularly in the Atyrau and West Kazakhstan regions. This piece comes from the West Kazakhstan Regional Museum of History and Local Lore, an authentic example dating to the 19th century.",
    "sedlo": "The saddle (er-toqym, or simply 'er') was the inseparable companion of warrior and hunter alike, the pinnacle of a thousand-year-old nomadic culture, in use since the ancient Saka era. Its wooden frame (qas) is carved from hard birch and lined inside with leather, wool, or sometimes felt; the outside is covered in leather and stamped with ornament. Originally made only for male warriors, elegant, slender women's saddles began to appear in the 18th and 19th centuries. This 19th-century saddle from the West Kazakhstan Regional Museum is decorated with openwork gilded plates and set with red carnelian stones at its center. Saddles of this quality belonged only to khans, biys, or wealthy families. A complete saddle assembly has more than 30 parts, including the girth, throat strap, bridle, reins, stirrups, and breast strap. Kazakhs today still display saddles like this one at ceremonial occasions.",
    "aibalta": "The aibalta is a battle-axe of the Kazakh warrior, known since ancient Turkic times. Its name comes from its shape — 'ai' (crescent moon) plus 'balta' (axe). The blade curves like a crescent, 15-25 cm long, mounted on a wooden or horn handle 60-80 cm in length; the whole weapon weighs 1-2 kg. It was used mainly in warfare — for close combat, capable of felling an enemy with a single blow from horseback. Handles were typically bound in silver, with silver ferrules and rings. Some aibaltas have a hole drilled through the handle for a thin cord, so the weapon would not be lost from the hand mid-battle. In the 18th and 19th centuries, the aibalta was more than a weapon — it marked out biys and wealthy men, and in legend it even appears as an enchanted weapon. Western Kazakh folklore preserves figures known as 'aibaltaly Abylai' and 'aibaltaly Naurizbai.' This 19th-century piece comes from the West Kazakhstan Regional Museum of History and Local Lore.",
    "qalqan": "The qalqan (shield) was the warrior's defensive weapon, a legacy stretching back a thousand years. This 18th-century shield is among the National Museum's prized exhibits — a convex, dome-shaped sheet of steel roughly 50-60 cm in diameter, with its rim and center bordered by brass plates. Its surface is finely engraved with images of foot soldiers and mounted warriors, wild animals such as the argali and the snow leopard, and inscriptions in Kufic Arabic calligraphy. Those Kufic inscriptions carry Quranic verses addressed to the warrior ('Sovereignty belongs to Allah...') along with protective prayers. The inner face is lined with red cloth and soft leather to cushion the impact of blows. Shields of this refinement belonged only to princes and biys and were rarely carried into actual combat — more often they were displayed at parades and celebrations. It represents the pinnacle of Turkic, Kazakh, and Central Asian craftsmanship.",
    "kubi": "The kubi is a wooden vessel used to make koumiss. Trapezoidal in shape — narrow at the top, wide at the base — it stands 60-80 cm tall, built from thin pine staves bound by three or four dark metal hoops. Inside sits the pispek, a long-handled (about 90 cm) wooden tool whose lower end carries a specially carved circular disc for churning. Mare's milk is poured into the kubi, a starter culture is added, and the mixture is churned with the pispek 1,000 to 2,000 times a day. This mechanical churning ferments the milk into 'tyng kymyz' — fresh koumiss. Some kubis were made one and a half to two times larger for big celebrations. In the Akmola, Karaganda, and Pavlodar regions, families kept such kubis in everyday use until the mid-20th century. Kazakhs today still rely on the kubi in koumiss-making.",
    "ojau": "The ojau is a wooden ladle for pouring koumiss, ayran, or shubat from the astau into cups and bowls. It is carved from a single piece of wood — birch, willow, or dark wood — measuring 30-50 cm long, with a bowl 6-10 cm deep. Its long handle is shaped for a comfortable grip and sometimes finished with fine carving. Most tableware among the ancient nomads was made of wood for good reason: it didn't slip or shatter, and it was light and easy to pack for travel. The ojau plays an important role in dastarkhan etiquette — it is always held by the eldest person present, who pours koumiss for the guests in order of seniority. At large celebrations, dozens of ojaus may be in use at once. Some craftsmen decorate the ladle with carving and add a small hook at the base for hanging it on the wall. This example, from a museum in the Akmola region near Astana, dates to the early 20th century. Kazakhs today still use the ojau at ethno-festivals and in traditional cuisine.",
    "sandyq": "The sandyq is a wooden chest in which a Kazakh family kept its most valuable possessions. It also played an important part in nomadic migration, loaded onto a camel for the long journey. It was made of birch, willow, black birch, or sometimes cedar, measuring 80-120 cm long and 40-60 cm high. The outside was covered with thin iron sheeting — both protective and decorative — while silver and brass plates, carved and engraved, adorned the center and sides. Inside it held the jasau (the dowry a young woman brought to her new household), an embroidered shapan, a kimeshek, silver jewelry, books, and family heirlooms. The blessing 'sandyq toly' ('may your chest be full') was spoken during the dowry-giving ceremony, wishing the couple an abundant household. In earlier times, chests were made by specialist craftsmen, and the mechanism for opening and closing them was considered a genuine art form — some locks required three or four different keys to open. For Kazakhs today, the sandyq stands as a symbol of an ancient culture.",
    "togyzqumalaq": "Togyzqumalaq is an ancient steppe logic game known among Kazakhs, Kyrgyz, and Turkmens alike. 'Togyz' plus 'qumalaq' translates as 'nine pebbles.' It belongs to the mancala family of games, which arose some 4,000-5,000 years ago in Africa and spread along the Great Silk Road. The board is carved from wood, occasionally from stone, with nine pits on each side and two larger 'kazans' in the middle for collecting captured pebbles. The game begins with 9 pebbles in every pit, 162 in total. Players take turns picking up the contents of a pit and sowing them clockwise into the following pits. Advanced rules include 'otau' (correctly setting up a trap pit) and 'tusim' (dropping a stone into an opponent's pit). A typical game lasts 30-60 minutes, though matches between grandmasters can run 3-4 hours. Kazakhstan founded its republican federation for the game in 1949. Today world championships are held, and it is an official sport at the Asian Games; schools have introduced dedicated togyzqumalaq lessons.",
    "sazsyrnai": "The saz syrnai is an ancient wind instrument made of fired clay, originating in the land of Turkistan. Its roots go back to the Bronze Age, the 2nd-1st millennium BCE. Shaped like a large egg, it has 6-12 finger holes. In earlier times it was chiefly an instrument for shepherds and children, played out on the summer pastures while herding livestock; it was occasionally used in religious rites as well, the clay instrument being thought to hold a direct connection with nature. Its range is limited, but its tone is clear and distinctive. Modern saz syrnais are being revived by pottery craftsmen and made in a variety of shapes — sheep, camel, bird, or the yurt's shanyrak. A version made for Turkistan's 1,500th anniversary in 2000 is preserved in the National Museum, decorated with the Khoja Ahmed Yasawi mausoleum, a camel caravan, and the inscription 'Turkistan 1500.' Today, ethno-musicians use the saz syrnai in ethno-jazz and world music.",
    "shanqobyz": "The shanqobyz (jaw harp) is an ancient reed instrument known to Turkic, Mongol, and Finno-Ugric peoples, and even to Native Americans. It originated in Asia some 4,000-5,000 years ago. It is made from a metal (sometimes wooden) plate with a thin, flexible tongue at its center. To play it, the performer holds the instrument firmly between the front teeth and sets the tongue vibrating with a finger; the mouth acts as a resonating chamber, and by shifting the tongue, lips, and breath, the player produces a range of melodies. It was used in ancient shamanic rites, trance meditation, and nighttime games. Among Kazakh campaigners, playing the shanqobyz at night was thought to 'summon the spirits of the soul.' A young man might play his own melody on the shanqobyz to declare his feelings to a girl. The instrument was nearly forgotten by the early 20th century, and national musicians are reviving it today. The Akmola region museum's example is a modern instrument made in 2015, though built using traditional technique. Worldwide, the jaw harp remains popular in ethno-jazz and world music.",
    "perstenj": "The 'bird's beak' ring is the work of 19th-century Kostanay jewelers and a striking example of Kazakh national jewelry art. Its bezel — the setting that holds the stone — is oval, with pointed ends resembling a bird's beak, which gives the piece its name. It is made of fine silver, set with a small stone: agate, carnelian, or turquoise. The decorative techniques include skan (filigree work in fine silver wire), zern (granulation, with tiny silver beads soldered on), and a plaited, braid-like border. According to old Kazakh belief, rings were never mere ornament but served as amulets — the stone inside was thought to protect its wearer from the evil eye and from illness. Each stone carried its own meaning: agate for authority, carnelian for domestic well-being, turquoise for a safe journey. In the Kostanay, Aktobe, and West Kazakhstan regions, every jeweler's family had its own craft, its secrets passed down strictly within the family line. This piece is held in the Kostanay Regional Museum of History and Local Lore.",
    "bilezik": "The bilezik (bracelet) has long been one of the principal ornaments of Kazakh women. Bracelets recovered from ancient burial mounds date back to the 7th-5th centuries BCE, the Saka era. Materials vary — silver, gold, a combination of the two — set with stones of different colors: carnelian, coral, turquoise, agate. The piece shown here is the work of contemporary Kazakh jeweler Kairat Bulatuly Shapabayev. It is a massive, open-form bracelet (not a closed loop, so it slips easily onto the hand), its surface decorated with geometric carving — triangles, rhombi, circles. The central feature is three oval agate stones, evenly spaced around the band and held in raised settings. In old Turkic tradition, the bracelet also served as an amulet: seeing a bracelet on the right hand was thought to bring good fortune. It was given as a wedding present and as a festive gift to young women. This piece belongs to the Shaimerdan Sariev Museum of Decorative and Applied Arts, home to one of Kazakhstan's largest jewelry collections.",
    "kese": "The kese is an 18th-19th century ceramic bowl originating from cities along the Great Silk Road — Otrar, Taraz, and Sayram. Medieval Otrar (Farab) was one of Central Asia's greatest centers of pottery-making; it was the birthplace of Al-Farabi, and the ancient city flourished from the 5th to the 16th centuries. Making such ceramics involved gathering local clay, shaping it on a potter's wheel, and firing it in a special kiln at 800-1000°C. This kese displays a distinctive technique known as 'white-ground glaze painting': a pattern in blue and brown mineral pigments applied over a white glaze. The motifs include plant designs (the tree of life), geometric figures, and occasionally Kufic inscriptions. A kese was traditionally used for drinking koumiss, tea, or talkan, a roasted-grain drink. This example belongs to the 'Shym Qala' historical-cultural complex, an open-air ethnographic museum near Shymkent, and it echoes the spirit of the medieval cities of Otrar, Sayram, and Isfijab.",
    "korzhyn": "The korzhyn is the traditional travel bag of the nomadic Kazakhs, a matched pair of pouches slung over a horse or camel. It dates back to the ancient Saka era — fragments of similar woven bags have been found in the Pazyryk burial mounds. It is woven from thick wool thread spun from sheep or camel hair, sometimes dyed with plant-based colors, using the terme and qazhaki weaving techniques — ancient, intricate methods that allow for richly colored patterns. Rectangular in shape, it folds at the middle to form a 'neck,' a narrow strap slung over a saddle or a shoulder. Both sides carry identical ornament, symbolizing balance. The most common motifs are the rhombus medallion (representing the sun, the world, and family), the ram's horn (symbol of abundance), the star, the flower, and the chain. Its color palette — deep red as the dominant tone, with white, black, green, purple, and yellow — comes from natural dyes such as madder, turmeric, and fig leaf. Tassels at the ends carry the meaning of being 'unseen by the evil eye,' serving as a protective amulet. Inside, travelers carried food for the road, dishes, small belongings, and sometimes books. A korzhyn was an important part of a bride's dowry, handed down from the ancestors to the new household. Kazakhs today use the korzhyn as a design element — in bags, interior decor, and as an accessory for national celebrations. This exhibit belongs to the collection of the National Museum of the Republic of Kazakhstan.",
    "syrmaq": "The syrmaq is the most intricate and refined type of traditional Kazakh felt carpet. Its base is felt — a dense fabric pressed from sheep's or camel's wool — worked using an appliqué, or mosaic, technique. The process begins with pressing felt in two colors, usually dark brown and white. The craftsman then cuts matching, pre-patterned pieces from each color and joins them with a fine, narrow seam, forming rhombus medallions, plant motifs, and ram's-horn patterns. A single syrmaq can take three to six months to complete. The three rhombus medallions at its center are read as a symbol of the three zhuzes, or of family members. The intricate branching design within each medallion represents the 'tree of life,' a remnant of ancient Turkic-Iranian mythology, while the surrounding ram's-horn motif symbolizes abundance, referring to livestock as the primary source of wealth. This particular syrmaq's palette is dominated by deep brown, with white inside the medallions and touches of purple and red elsewhere. A syrmaq was spread at the tor, the place of honor in the yurt, and sometimes formed part of a bride's dowry. In the old Kazakh villages, every family had its own syrmaq, carrying its own beliefs and its own history. Craftspeople working today, especially in Turkistan Region, keep this tradition alive, producing syrmaqs suited to modern interiors. The syrmaq is currently being prepared for nomination to UNESCO's Intangible Cultural Heritage list.",
    "dulyga": "The dulyga is the iron protective helmet of the Kazakh warrior. Its distant roots lie in the iron helmets of the Saka, Hun, and Turkic eras, dating to the 7th-5th centuries BCE; similar iron and bronze helmets have been recovered from the Pazyryk burial mounds. During the Kazakh campaigns of the 18th and 19th centuries, the dulyga remained the principal protection for the head — in the years of the Dzungar invasion (1723-1750), the batyrs Abylai, Kabanbai, Naurizbai, and Bogenbai rode into battle wearing helmets of exactly this kind. The piece shown here is a precise reconstruction made by the contemporary craftsman Alibai Berik Satynbekuly, based on authentic 18th-19th century examples. Its construction is intricate: the domed upper section is forged from a single sheet of iron, topped with a sharp metal spike meant to intimidate the enemy or to hold a feather or standard. A thin frontal plate across the brow shields the warrior's eyes. The outer surface bears carving in the style of Arabic calligraphy — Quranic verses and protective prayers, including the surah 'An-Nasr.' The lower edge carries a barmitsa, a mail curtain woven from thin iron rings (5-8 mm in diameter) that guards the neck, throat, and shoulders from a sword's blow. A single barmitsa may contain 15,000 to 20,000 rings, taking a craftsman several months to complete. In earlier times, such chainmail belonged only to khans and eminent batyrs — it was an extraordinarily costly possession. Alibai Berik Satynbekuly is a modern blacksmith reviving the ancient tradition of ironworking; his workshop fully recreates the equipment of the 18th-19th century Kazakh warrior. This exhibit is held at the Shaimerdan Sariev Museum of Decorative and Applied Arts."
  }
};
